...
const Animated = () => {
  ...
  return <Box as="div" width="100vw" height="100vh" pos="fixed" zIndex={-1} left={0} top={0}>
    <StyledDiv
      width='min(60vw, 60vh)' height='min(55vw, 55vh)' position="fixed" left='40vw' top='30vh' bgGradient={`linear(to-r, #4db6ac20, #b54b5610)`} borderRadius='50%'
    ...
    <StyledDiv
      width='min(65vw, 65vh)' height='min(75vw, 75vh)' position="fixed" left='30vw' top='10vh' borderRadius='50%' bgGradient={`linear(to-tl, #b54b5610, #4db6ac20)`}
